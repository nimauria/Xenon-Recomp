...
QVariantList SettingsCatalog::categories() {
  return {
      ...
      QVariantMap{{"id", "updates"}, {"name", "Updates"}, {"feature", "settings.updates"}, {"page", 9},
                  {"keywords", "updates modules catalog releases prerelease automatic interval"}},
      QVariantMap{{"id", "community"}, {"name", "Community"}, {"feature", "settings.community"}, {"page", 10},
                  {"keywords", "discord community support help rich presence social powered by xenon"}},
      QVariantMap{{"id", "accessibility"}, {"name", "Accessibility"}, {"feature", "settings.accessibility"}, {"page", 11},
                  {"keywords", "text size scale contrast motion keyboard focus accessibility"}},
      QVariantMap{{"id", "developer"}, {"name", "Developer"}, {"feature", "settings.developer"}, {"page", 12},
