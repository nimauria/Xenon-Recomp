...
Item {
    ...
    ColumnLayout {
        ...
        XPanel {
            ...
            implicitHeight: Math.max(420, captureContent.implicitHeight + Theme.spaceLg * 2)
                        ...
                        Repeater {
                            ...
                            delegate: XPanel {
                                ...
                                RowLayout {
                                    ...
                                    XButton { text: "Delete"; variant: "danger"; onClicked: launcherBridge.deleteCaptureFile(filePath) }
                                }
                            }
                        }
                    }
