...
int main(int argc,char**argv){
  ...
  std::vector<Spec> specs = {
    ...
    {"smoke_vand",0x103Cu,0x10000404u|(3u<<21)|(1u<<16)|(2u<<11)},
    {"smoke_vandc",0x1040u,0x10000444u|(3u<<21)|(1u<<16)|(2u<<11)},
    {"smoke_vor",0x1044u,0x10000484u|(3u<<21)|(1u<<16)|(2u<<11)},
    {"smoke_vxor",0x1048u,0x100004C4u|(3u<<21)|(1u<<16)|(2u<<11)},
    {"smoke_vnor",0x104Cu,0x10000504u|(3u<<21)|(1u<<16)|(2u<<11)},
    {"smoke_vnor128",0x1050u,0x14000290u|(3u<<21)|(1u<<16)|(2u<<11)},
    {"smoke_vand128",0x1054u,0x14000210u|(3u<<21)|(1u<<16)|(2u<<11)},
    {"smoke_vsel",0x1058u,0x1000002Au|(3u<<21)|(1u<<16)|(2u<<11)|(4u<<6)},
    {"smoke_vsel128",0x105Cu,0x14000350u|(3u<<21)|(1u<<16)|(2u<<11)},
