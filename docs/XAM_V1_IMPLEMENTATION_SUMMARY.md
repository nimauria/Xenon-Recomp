...
### Documentation
- `docs/XAM_V1.md` - Complete XAM V1 specification and design documentation
...
3. **XAM Exports Implemented**
   - `XamUserGetXUID` (0x0180) - Get XUID for user index
   - `XamUserGetSigninState` (0x0181) - Get sign-in state
   - `XamUserGetName` (0x0183) - Get gamertag
   - `XamUserCheckPrivilege` (0x0187) - Check privileges (stubbed for offline)
